...
// 40–100: Transition to Chevron (mirrored — AR goes right, buddy team 2 goes left)
// 100–150: Hold Chevron
// Mirrored version: x positions reflected around x=300, rotations negated

const TRANSITION_START = 40;
const TRANSITION_END = 100;

// ── File positions (vertical column, AR at center) ───────────────────────────
const file = {
  ftl: { x: 300, y: 195 },
  ar:  { x: 300, y: 300 },
  gr:  { x: 300, y: 405 },
...
// ── Chevron positions (mirrored V-shape, FTL stays in place) ─────────────────
// Original: AR(205,280), GR(400,280), RFL(495,355)
// Mirrored around x=300: AR(395,280), GR(200,280), RFL(105,355)
const chevron = {
  ftl: { x: 300, y: 195 },
  ar:  { x: 395, y: 280 },
  gr:  { x: 200, y: 280 },
...
export const FileToChevronARMirrored: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    ...
    >
      <svg width={600} height={600} viewBox="0 0 600 600">
        ...
        <SpeechBubble x={ftl.x} y={ftl.y - 30} text="Шеврон. Пулемёт справа" opacity={bubbleOpacity} />
